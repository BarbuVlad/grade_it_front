...
const ViewSingleResultAsTeacher = () => {
    ...
    useEffect(()=>{
        ...
        const fetch_result = async () =>{
          try{
            const results_fetch = await fetch(`http://192.168.206.129:5000/classes/view_user_results?test_id=${id}&user_id=${localStorage.getItem("id_user_to_view")}`, {
              method: 'GET',
...
export default ViewSingleResultAsTeacher
